...
import QDEAnswers from "@/components/QuestionsTypes/Sound/Edit/QDEAnswers";
import { AiFillSave } from "react-icons/ai";
import axios from "axios";
import { useRouter } from "next/navigation";
import { useSearchParams } from "next/navigation";

export default function EditSoundQuestion() {
    ...
    try {
      ...
      for (let i = 0; i < answera.length; i++) {
        ...
        if (item.is_new !== undefined) {
          ...
          ansForm.set("sound", item.fileE); // como se va  a crear entonces se envia
          ansForm.set("answer_image", item.fileEI); //
