...
import QSCAnswers from "@/components/QuestionsTypes/Selection/Create/QSCAnswers";
  ...
  */
  ...
  const SaveQuestion = async () => {
    try {
      ...
      form.set("type_question", "selection_text");
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <QSCAnswers onReturnAnswrs={ReturnAnswers} />
      </div>
    </div>
  );
}
