...
import QFCBody from "@/components/QuestionsTypes/Face/Create/QFCBody";
import QFCAnswers from "@/components/QuestionsTypes/Face/Create/QFCAnswers";
  ...
  */
  ...
  const SaveQuestion = async () => {
    try {
      ...
      form.set("type_question", "face"); // --> AQUI CAMBIAR EL TIPO DE PREGUNTA PARA EL SWITCH QUE RENDERIZA EL TIPO DE PREGUNTA PARA EL JUEGO
      ...
      for (let i = 0; i < Answers.length; i++) {
        ...
        // fileE
        ansForm.set("image_path", Answers[i].fileP);

        const resulta = await axios.post(`${apiUrl}/faceanswer/`, ansForm, {
          /*
        headers: {
          "Content-Type": "application/json",
        }, */
