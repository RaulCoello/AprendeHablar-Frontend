...
import QICAnswers from "@/components/QuestionsTypes/Image/Create/QICAnswers";
  ...
  */
  ...
  const SaveQuestion = async () => {
    try {
      ...
      form.set("type_question", "image"); // --> AQUI CAMBIAR EL TIPO DE PREGUNTA PARA EL SWITCH QUE RENDERIZA EL TIPO DE PREGUNTA PARA EL JUEGO
      ...
      for (let i = 0; i < Answers.length; i++) {
        ...
        // fileE
        ansForm.set("answer_image", Answers[i].fileE);
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <QICAnswers onReturnAnswrs={ReturnAnswers} />
      </div>
    </div>
  );
}
