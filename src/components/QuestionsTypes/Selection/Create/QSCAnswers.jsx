                  ...
                  <div className="flex flex-col gap-2">
                    <div className=" flex flex-col gap-2">
                      ...
                      <div className="flex flex-row  gap-3">
                        <button
                          className="flex-1 z-10 cursor-pointers flex  w-full justify-center items-center text-center content-center self-center  rounded-4xl p-2 font-normal text-lg"
                          style={{
                            backgroundColor: answer.color || "#fb923c",
                          }}
                          onClick={() => (
